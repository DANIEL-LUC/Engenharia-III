...
<div id="container">
  <h1>&bull; Cadastro Modelo &bull;</h1>
  <div class="underline">
  </div>
  ...
  <form action="ModeloAutomovel" method="post" id="contact_form">
    ...
    <div class="name">
      ...
      <input type="text" placeholder="Nome modelo" name="txtNomeModelo" id="txtNomeModelo" required>
    </div>
    <div class="anoLancamento">
      <label for="name"></label>
      <input type="date" placeholder="Ano Lançamento" name="txtAnoLancamento" id="txtAnoLancamento" required>
    </div>
    <div class="preco">
      <label for="name"></label>
      <input type="number" step="0.01" placeholder="Preço médio" name="txtPreco" id="txtPreco" required>
    </div>
    <div class="subject">
    ...
    <div class="selectRight">
      ...
      <select placeholder="Cambio" name="txtCambio" id="txtCambio" required>
        <option disabled hidden selected>Cambio</option>
    ...
    <div class="valorLeft">
     ...
     <div class="selectLeft">
      ...
      <select placeholder="Combustivel" name="txtTipoAutomovel" id="txtTipoAutomovel" required>
        <option disabled hidden selected>Tipo automovel</option>
